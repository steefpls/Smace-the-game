...
double Entity::anglebetween(Entity &ent1, Entity &ent2)
{
	double Xdiff = ent2.getCenterX() - ent1.getCenterX();
	double Ydiff = ent2.getCenterY() - ent1.getCenterY();

	return atan(Ydiff / Xdiff)/(2*PI) *360;
}